...
public class GroupServiceTests : IAsyncLifetime
{
    ...
    private ReadOnlyMemory<byte> AdminPrivateKey =>
        _scenario.Admin.Keys.X25519PrivateKey;
    ...
    public async Task CreateGroup_MembersCanUnwrapSameCek()
    {
        ...
        var userPrivKey = _scenario.User.Keys.X25519PrivateKey;
    ...
    // AdminSignature (crypto-permissions.ts: resolveSenderPermissions), so missing signatures here
