...
public class DeclarationSignerTests
{
    ...
    private async Task<(string Ed25519Pub, byte[] Ed25519PrivBytes)> GenerateKeysAsync(byte seedByte)
    {
        ...
        return (keys.Ed25519PublicKey, keys.Ed25519PrivateKey);
    }
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(1);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(2);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(3);
    ...
    {
        var (_, privA) = await GenerateKeysAsync(4);
        var (pubB, _) = await GenerateKeysAsync(5);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(10);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(11);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(20);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(21);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(30);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(31);
        var timestamp = new DateTimeOffset(2026, 4, 12, 10, 30, 0, TimeSpan.Zero);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(40);
    ...
    {
        var (pub, priv) = await GenerateKeysAsync(41);
