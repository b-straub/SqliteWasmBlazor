...
public static class TestRegistry
{
    ...
    [
        ...
        "ExecuteUpdateDelete_BulkOperations",
        "RawSql_QueryCommand",
        "FTS5_Search",
        "FTS5_SoftDeleteThenClear",

        // ADO.NET
        "AdoNet_AsyncCommandRoundTrip",
        "AdoNet_CommandBehaviorCloseConnection",
        "AdoNet_CommandBehaviorReaderOptions",
        "AdoNet_CommandTypeValidation",
        "AdoNet_ConnectionStringParsing",
        "AdoNet_ConstraintConflictHandling",
        "AdoNet_ParameterDbTypeBinding",
        "AdoNet_ParameterDateOnlyTimeOnly",
        "AdoNet_ReaderDateOnlyTimeOnly",
        "AdoNet_EmptyReaderMetadata",
        "AdoNet_NativeAggregateWindowFunctions",
        "AdoNet_NativeDateTimeFunctions",
        "AdoNet_NativeFts5Functions",
        "AdoNet_NativeJsonFunctions",
        "AdoNet_NativePragmaIntrospection",
        "AdoNet_NativePragmaSettings",
        "AdoNet_NativeScalarFunctions",
        "AdoNet_NativeStateFunctions",
        "AdoNet_NativeVirtualTableModules",
        "AdoNet_ParameterPrefixCompatibility",
        "AdoNet_ReaderOrdinalCompatibility",
        "AdoNet_ReaderRecordsAffected",
        "AdoNet_ReaderSchemaTable",
        "AdoNet_ReaderStreamingAccess",
        "AdoNet_ReaderTypedFieldValues",
        "AdoNet_ReturningClauses",
        "AdoNet_RowsAffectedStatementPrefixes",
        "AdoNet_SyncCommandApisThrow",

        // Transactions
        "Transaction_Commit",
        "Transaction_Rollback",
        "Transaction_DisposeRollsBack",
        "Transaction_ConcurrentBeginSerializes",
        "Transaction_BlocksIndependentCommand",
        "Transaction_IsolationLevel",
        ...
        "EFCoreFunctions_ConversionTranslations",
        "EFCoreFunctions_CommonQueryTranslations",
        "EFCoreFunctions_StringAdvancedTranslations",
        "EFCoreFunctions_CollectionPredicateTranslations",
        "EFCoreFunctions_TypedPredicateTranslations",
        "EFCoreFunctions_DateTimeTranslations",
        "EFCoreFunctions_DateOnlyTimeOnlyParameters",
        "EFCoreFunctions_GroupedAggregateSetOperations",
        "EFCoreFunctions_MathTranslations",
        "EFCoreFunctions_SqliteSpecificDbFunctions",
