...
async function initializeSQLite() {
    try {
        ...
        // creation. A POS-style offline workload can open enough logical
        // databases that 25 slots still trips "SAH pool is full" during
        // journal creation, so keep enough headroom for realistic app data,
        // temp journals, imports, and backup/export probes.
