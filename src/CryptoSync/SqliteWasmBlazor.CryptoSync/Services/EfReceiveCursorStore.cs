...
/// </para>
/// </summary>
internal sealed class EfReceiveCursorStore(CryptoSyncContextBase context) : IReceiveCursorStore
{
...
/// </summary>
internal sealed class EfReceiveCursorStoreFactory<TContext>(IDbContextFactory<TContext> contextFactory)
    : IReceiveCursorStore
