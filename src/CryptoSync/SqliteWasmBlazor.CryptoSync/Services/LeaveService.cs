...
internal class LeaveService(
    ...
    DeclarationSigner signer) : ILeaveService
{
    /// <summary>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Sign the leave declaration. Priv-key bytes alias memberKeys; caller
        // owns the DualKeyPairFull lifecycle and Clear()s at EOL (P21).
        var signature = await signer.SignLeaveDeclarationAsync(
            memberKeys.Ed25519PrivateKey, groupContext, group.KeyVersion);
