// bulk-ops.ts
// V2 MessagePack bulk import — prepared statement loop with conflict resolution.
 ...
 */
export function buildInsertSql(header: V2Header, conflictStrategy: number): string {
